...
<!--       
      <section>
        ...
        <div id="p3p3-content" style='display:none;'>
          ...
          <ul>
            <li>Create a web page using HTML and CSS.</li>
            <li>Create an interactive experience using p5.js.</li>
            <li>Send it out piece by piece as a TinyLetter.</li>
            <li>Create an online identity that is the representation of all the collective voices.</li>
            <li>?</li>
          </ul>
      ...
      <section>
        ...
        <div id="p1p3-content" style='display:none'>
          ...
          <ol>
            ...
            <li>Mockups – Come up with two different, distinct design directions. Use Illustrator or a similar program to create a mockup for each, including at minimum, the homepage and one additional page. Consider typography, imagery, color.</li>
          </ol>
          <br>
        </div>
        ...
        <div id="p1p4-content" style='display:block'>
          ...
          <ol>
            ...
            <li>Finalize the navigation and make sure the pages link correctly between themselves.</li>
            <li>Add a stylesheet and define the basic layout of your pages.</li>
            <li>Populate the HTML with content.</li>
            <li>Further implement the design with CSS, tweaking HTML as necessary.</li>
            <li>Test with users, iterate as necessary.</li>
          </ol>
