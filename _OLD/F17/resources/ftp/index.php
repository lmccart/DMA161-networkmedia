  ...
  <div class="container">
    ...
    <div class="right">
      ...
      <section>
        ...
        <li>SFTP is also pre-installed on OS X's Terminal, accesible via <code>sftp <a href="mailto:yourusername@ftp.dma.ucla.edu" target="_blank">yourusername@ftp.dma.ucla.edu</a></code></li>
        </ul>
      </section>
